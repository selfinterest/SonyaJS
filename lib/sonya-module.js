...
SonyaModule.prototype.resolveDependencies = function(){
    ...
    this.dependencies.forEach(function(moduleOrModuleName){
        if(_.isString(moduleOrModuleName)){
            module = Sonya.module(moduleOrModuleName);
        } else {
...
SonyaModule.prototype.getDependencyMap = function(){
    var my = this, dependencyMap = {}, module;
    var Sonya = require("./sonya.js");
   
    if(!this.dependencyMap){
        this.dependencies.forEach(function(moduleOrModuleName){
            if(_.isString(moduleOrModuleName)){                                     //get the module
                module = Sonya.module(moduleOrModuleName);
            } else {
                module = moduleOrModuleName;
            }
            dependencyMap[module.name] = module.providers;
        });
